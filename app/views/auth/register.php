...
<div class="max-w-lg mx-auto  bg-white dark:bg-gray-800 rounded-lg shadow-md px-8 py-10 flex flex-col items-center">
    ...
    <form action="#" class="w-full flex flex-col gap-4">
      ...
      <div class="flex items-start flex-col justify-start">
        <label for="username" class="text-sm text-gray-700 dark:text-gray-200 mr-2">role :</label>
        <select type="text" id="username" name="username" class="w-full px-3 dark:text-gray-200 dark:bg-gray-900 py-2 rounded-md border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-blue-500">
          <option value=""></option>
    ...
    <div class="mt-4 text-center">
      ...
      <a href="login.php" class="text-blue-500 hover:text-blue-600">Login</a>
    </div>
    </form>
  </div>
