                ...
                <table class="table-auto min-w-full rounded-xl">
                    <thead>
                        <tr class="bg-gray-50">
                            ...
                            <th scope="col" class="p-5 text-left whitespace-nowrap text-sm leading-6 font-semibold text-gray-900 capitalize  "> Full Name </th>
                        ...
                        <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">
                                <div class="w-48 flex items-center gap-3">
                                    ...
                                    <div class="data">
                                        <p class="font-normal text-gray-900"> </p>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> </td>
                            <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                <span class="font-medium text-xs text-emerald-600"></span>
                            </td>
                            <td class="flex p-5 items-center gap-2">
                                <a href="?supprimeUser= " class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-red-600 flex item-center">
                                ...
                                <a href="?banUser= " class="p-2 rounded-full bg-white group transition-all duration-500 hover:bg-yellow-500 flex items-center">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path class="fill-yellow-500 group-hover:fill-white" d="M10 0C4.477 0 0 4.477 0 10C0 15.523 4.477 20 10 20C15.523 20 20 15.523 20 10C20 4.477 15.523 0 10 0ZM10 18C5.589 18 2 14.411 2 10C2 5.589 5.589 2 10 2C14.411 2 18 5.589 18 10C18 14.411 14.411 18 10 18ZM13 9H7V11H13V9Z" />
                                    </svg>
                                </a>
                            </td>
                        </tr>
